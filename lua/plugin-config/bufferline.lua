...
vim.keymap.set("n", "<leader>bo", "<cmd>BufferLinePick<cr>", { noremap = true, silent = true })
vim.keymap.set("n", "<leader>bc", "<cmd>BufferLinePickClose<cr>", { noremap = true, silent = true })

vim.keymap.set("n", "<leader>bt", "<cmd>BufferLineTogglePin<cr>", { noremap = true, silent = true })
...
vim.keymap.set("n", "<leader>bs", "<cmd>BufferLineSortByDirectory<cr>", { noremap = true, silent = true })

-- vim-bbye
vim.keymap.set("n", "<leader>bd", "<cmd>Bdelete<CR>", {noremap=true,silent=true})
vim.keymap.set("n", "<leader>bw", "<cmd>Bwipout<CR>", {noremap=true,silent=true})
