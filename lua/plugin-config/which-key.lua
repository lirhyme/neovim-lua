...
local nmappings = {
  ...
  t = {
    ...
    u = { "<cmd>lua _NCDU_TOGGLE()<cr>", "NCDN" },
  ...
  l = {
    ...
    d = { "<cmd>Telescope lsp_document_diagnostics<cr>", "Doucmet Diagnostics" },
